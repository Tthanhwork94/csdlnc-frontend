...
//   var check =document.getElementById("sdt").value ;
//   var check2 =document.getElementById("diachi").value
//   if (check!="" && check2!=""){
//   for (var i = 0; i < order.length; i++) {
//     var button = order[i]
//     button.addEventListener("click", function () {
//       var button_remove = order[i]
...
//     }
//     total=total+ship;
//     document.getElementsByClassName("cart-ship-price")[0].innerText = '20000VNĐ'
...
//   //Nếu title của sản phẩm bằng với title mà bạn thêm vao giỏ hàng thì không thêm được
